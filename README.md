...
This repo deploys as the `peagen-com` self-hosted Docker service. DNS is managed through the PyPI `npmctl-namecheap==0.3.8` provider for the `peagen.com` zone and is declared in `desired-state/dns.yaml`.
